    ...
    constructor(client) {
        super(client, {
            ...
            args: [
                {
                    key: 'text',
                    prompt: 'The first word is the command, then the template you want (see templates by typing `meme_templates`), then the top text and bottom text separated by a hyphen, eg: meme waitingskeleton This is top text-This is bottom text',
                    type: 'string'
                }
            ]
        });
